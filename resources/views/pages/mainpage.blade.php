    ...
    <div id="slidehome" class="slidehome">
        <div class="centerup">
            <form method="POST" action="/">
                <input type="text" id="search-term" class="form-control w-300 inline" placeholder="Enter a Restaurant Name,Food Name, Location ..." />
                <input type="submit" id="search" value="Go!" class="btn btn-default btn-search" />
            </form>
        </div>
        <div class="col-xs-6 text-center">
            <img src="http://www.hellofood.com/wp-content/uploads/2014/08/burger.png" />
        </div>
        <div class="col-xs-6 text-center">
            <img src="http://www.hellofood.com/wp-content/uploads/2014/08/pizza.png" />
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="search-filter">
                ...
                <form id="search-filter-form" role="form">
                    ...
                    <input type="submit" id="search" value="Go!" class="btn btn-success btn-search" />
                </form>
            </div>
        </div>
    </div>
