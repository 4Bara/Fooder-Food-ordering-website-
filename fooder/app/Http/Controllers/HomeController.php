...
//            dd($aCuisines[1]['id_cuisines']);
        ...
        public function search(){
            ...
            $aRestaurantsParams = array("restaurant_name","username","telephone","id_restaurant","rating","price_range","id_country");
            ...
            if(!empty($aRestaurantsIds)){
               ...
               // dd($aRestaurants);
                if(!empty($aRestaurants)){
                   // dd($aRestaurants);
                  $FinalResults= array_merge($FinalResults['restaurants'],$aRestaurants);
                }
            }
